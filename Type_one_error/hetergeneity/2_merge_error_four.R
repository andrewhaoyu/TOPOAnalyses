...
rm(list=ls())
# setwd("/data/shengf2/simu_mtop/type1_hert/result_four/result")
# setwd("/data/shengf2/simu_mtop/type1_hert/result_four/result1")
# setwd("/data/shengf2/simu_mtop/type1_hert/result_four/result2")
setwd("/data/shengf2/simu_mtop/type1_hert/result_four/result3")
