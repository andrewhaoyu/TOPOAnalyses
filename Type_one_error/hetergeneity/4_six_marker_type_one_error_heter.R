...
for(k in 1:length(size)){
  ...
  for(i in 1:s_times){
    # print(i)
    if (i %%100==0){
      cat("Replication",i,"under size=",n,"is running!!\n")
    }
...
save(p_global_result_ftop,file=paste0("./result_six/result1/ftop_",i1,".Rdata"))
save(p_global_result_mtop1,file=paste0("./result_six/result2/mtop1_",i1,".Rdata"))
save(p_global_result_mtop2,file=paste0("./result_six/result3/mtop2_",i1,".Rdata"))
save(p_acat,file=paste0("./result_six/result/acat",i1,".Rdata"))
