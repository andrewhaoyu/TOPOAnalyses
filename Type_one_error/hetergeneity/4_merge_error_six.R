...
rm(list=ls())
# setwd("/data/shengf2/simu_mtop/type1_hert/result_six/result")
# setwd("/data/shengf2/simu_mtop/type1_hert/result_six/result1")
# setwd("/data/shengf2/simu_mtop/type1_hert/result_six/result2")
setwd("/data/shengf2/simu_mtop/type1_hert/result_six/result3")
...
pvalues = matrix(pvalues0[i1,], ncol = 1)
...
res
# write.csv(res,paste0("../results",nfiles,"_six_acat.csv"), row.names =TRUE)
# write.csv(res,paste0("../results",nfiles,"_six_ftop.csv"), row.names =TRUE)
# write.csv(res,paste0("../results",nfiles,"_six_mtop1.csv"), row.names =TRUE)
write.csv(res,paste0("../results",nfiles,"_six_mtop2.csv"), row.names =TRUE)
