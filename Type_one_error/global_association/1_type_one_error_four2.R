...
save(p_ftop,file=paste0("./result_four2/result1/ftop_",i1,".Rdata"))
save(p_mtop1,file=paste0("./result_four2/result2/mtop1_",i1,".Rdata"))
save(p_mtop2,file=paste0("./result_four2/result3/mtop2_",i1,".Rdata"))
save(p_acat,file=paste0("./result_four2/result/acat",i1,".Rdata"))
