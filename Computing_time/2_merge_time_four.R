...
rm(list=ls())
setwd("/data/shengf2/simu_mtop/time/result_four")
...
# save(tm_mtop,tm_topo, file ="../Four_time.Rdata")
...
res = res*100/3600
res
# write.csv(res,paste0("../results_four_test",nfiles,".csv"), row.names =TRUE)
